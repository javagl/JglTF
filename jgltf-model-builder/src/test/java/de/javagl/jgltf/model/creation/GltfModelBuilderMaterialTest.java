...
public class GltfModelBuilderMaterialTest
{
    public static void main(String[] args) throws Exception
    {
        GltfModel gltfModel = createWithMaterial();
        printEmbedded(gltfModel);
    }

    @Test
    public void testWithMaterial()
    {
        GltfModel gltfModel = createWithMaterial();
        ...
        assertEquals(5, imageModels.size());
        assertEquals(1, materialModels.size());
        ...
        assertEquals(5, textureModels.size());
        assertNotNull(extensionsModel);
        assertNotNull(assetModel);
    }

    private static DefaultGltfModel createWithMaterial()
    {
        int indices[] = { 0, 1, 2 };
        float positions[] =
        {
        ...
        // Create a material that uses all core textures (5 textures)
        TextureModel textureModel0 = createTestTextureModel("test0");
        TextureModel textureModel1 = createTestTextureModel("test1");
        TextureModel textureModel2 = createTestTextureModel("test2");
        TextureModel textureModel3 = createTestTextureModel("test3");
        TextureModel textureModel4 = createTestTextureModel("test4");
        
        MaterialBuilder b = MaterialBuilder.create();
        b.setBaseColorTexture(textureModel0, null);
        b.setMetallicRoughnessTexture(textureModel1, null);
        b.setNormalTexture(textureModel2, 1.0, null);
        b.setOcclusionTexture(textureModel3, 1.0, null);
        b.setEmissiveTexture(textureModel4, 1.0, 1.0, 1.0, null);
        MaterialModel materialModel = b.build();
    ...
    private static TextureModel createTestTextureModel(String name)
    {
        DefaultTextureModel textureModel = 
            TextureModels.createLabel(name + ".png", 100, 100, 10, name);
        return textureModel;
    }
